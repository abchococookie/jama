...
## Introduction
![visual_abstract](jama_lodestar_figs/jama_lodestar_summary.png)
...
## Methods
### Randomization and Study Procedures
![participants](jama_lodestar_figs/jama_lodestar_fig1.png)
## Methods
### Randomization and Study Procedures
...
- target LDL-C level
  - treat-to-target group: below 70 mg/dL
    - statin naive - moderate initiated
    - uptiteration:70 mg/dL ~
...
2. Test of NI for the primary endpoint using Com_Nougue approach to estimating the z statisticc for the Kaplan-Meier failure rates with the Greenwood formula for estimating the standard error
- primary analysis: PP group
...
## Results
### Base
![table 1](jama_lodestar_figs/jama_lodestar_tb1.png)
## Results
### Base
- 98.7% completed the 3-year clinical follow-up
![fig2a](jama_lodestar_figs/jama_lodestar_fig2a.png)
...
## Results
### Base
![fig2b](jama_lodestar_figs/jama_lodestar_fig2b.png)
...
## Results
### LDL-C level
![fig3a](jama_lodestar_figs/jama_lodestar_fig3a.png)
...
- overall period: no significant difference (p = .21)
...
::: {.column width = "40%"}
![tb2](jama_lodestar_figs/jama_lodestar_tb2.png)
:::

::: {.column width = "50%"}
![fig3b](jama_lodestar_figs/jama_lodestar_fig3b.png)
:::

## Results
### Primary Endpoint
- primary endpoint occured in 8.3% of treat-to-target group and 8.5% of high-intensity group
...
3. small num of events -> domparison of individual clinical outcomes within the primary endpoint was difficult
